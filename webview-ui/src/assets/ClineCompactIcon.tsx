/**
 * @fileoverview Cline 紧凑型图标组件
 *
 * 这是 Cline 品牌 Logo 的紧凑版本，用于 UI 中空间有限的场景。
 * 图标是一个可爱的机器人头像，具有以下特征：
 * - 圆角矩形的机器人头部（带缺口边框）
 * - 头顶的天线/触角
 * - 两只大眼睛
 *
 * 使用 SVG 绘制，支持通过 CSS currentColor 继承父元素的颜色。
 */

/**
 * ClineCompactIcon 紧凑型 Cline 图标
 *
 * 一个 16x16 像素的 SVG 图标组件，表示 Cline 的品牌标识。
 * 图标颜色通过 CSS currentColor 继承，可通过父元素的 color 属性控制。
 *
